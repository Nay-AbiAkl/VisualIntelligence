...
# ViTMAE
The ViTMAE was finetuned on examples from Gibson environment using the notebook titled "vitmae.ipynb". The notebook shows the different functions used for finetuning and the metrics used for assessment which are MSE, SSIM and PSNR. 