...
class PointNavResNetNet(Net):
    ...
    def __init__(
        ...
        ############################# Added modifications ##################################
        # Implement the graph encoder for the graph-based navigation
        # update the rnn input size
    ...
    def forward(
        ...
        if not self.is_blind:
            ...
            ############################# Added modifications ##################################
            # use the visual features as inputs to the graph network while taking care
            # of the batch size
