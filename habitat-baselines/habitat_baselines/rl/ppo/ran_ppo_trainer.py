...
@baseline_registry.register_trainer(name="ran_ddppo")
@baseline_registry.register_trainer(name="ran_ppo")
class RANPPOTrainer(BaseRLTrainer):
    ...
    def _compute_actions_and_step_envs(self, buffer_index: int = 0):
        ...
        self.rollouts.insert(
            next_recurrent_hidden_states=0,
            actions=actions,
